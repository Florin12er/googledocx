export const templates = [
  ...
  },
  {
    ...
    imageUrl: "/letter.svg",
    initialContent: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; box-shadow: 2px 2px 12px rgba(0,0,0,0.1);">
  <p style="text-align: right;">[Your Name]<br>[Your Address]<br>[City, State, Zip Code]<br>[Date]</p>
  <p>[Recipient's Name]<br>[Recipient's Address]<br>[City, State, Zip Code]</p>
  <p>Dear [Recipient's Name],</p>
  <p style="text-indent: 20px;">I hope this letter finds you well. I am writing to [state the purpose of your letter]. Please let me know if you require any further information.</p>
  <p style="text-indent: 20px;">Thank you for your time and consideration. I look forward to your response.</p>
  <p>Sincerely,</p>
  <p>[Your Name]</p>
</div>
    `,
